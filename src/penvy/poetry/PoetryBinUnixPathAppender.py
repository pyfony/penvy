...
class PoetryBinUnixPathAppender(SetupStepInterface):
    ...
    def run(self):
        self._logger.info("Adding poetry to PATH")
    ...
    def get_description(self):
        return "Add Poetry to PATH"

    def should_be_run(self) -> bool:
        return platform.system() != "Windows" and self._expected_shell_is_running and (
            not os.path.isfile(self._profile_path) or not file_contains_string(self._get_path_modifying_command(), self._profile_path)
        )
